...
class CryptoXORBase {
     ...
     * Must be implemented by the child class (SFC32ECC, Xoshiro, etc).
     * @abstract
    ...
    encrypt(input, options = {}) {
        ...
        // @ts-ignore - 'constructor' refers to the Child Class (e.g. SFC32ECC)
        ...
        if (options.ecc) {
            ...
            // We pass 'sessionCipher' which holds the logic (SFC32ECC) and state
