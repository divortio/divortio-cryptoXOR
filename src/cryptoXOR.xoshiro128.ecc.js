...
class Xoshiro128ECC extends CryptoXORECC {
    ...
    constructor(key, ivOrStrategy) {
        ...
        // --- SEEDING (SplitMix32ECC Algorithm) ---
        // Xoshiro requires a 128-bit state initialized by a different PRNG.
        // We use a robust SplitMix32ECC derived from Key + IV.
        ...
        // SplitMix32ECC Generator Function (Inlined)
    ...
    next() {
        ...
        const result = Math.imul(Xoshiro128ECC.rotl(Math.imul(s1, 5), 7), 9) | 0;
        ...
        this.s2 ^= t;
        this.s3 = Xoshiro128ECC.rotl(this.s3, 11);
